    ...
    mod encode {
        ...
        fn test_string_array_len_2() {
            ...
            assert_eq!(
                calldata.to_vec(),
                hex!(
                    ""
                )
            );
        }
    }
